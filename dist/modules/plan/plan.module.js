...
const plan_resolver_1 = require("./plan.resolver");
...
exports.PlanModule = PlanModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([Plan_1.Plan])],
        providers: [plan_service_1.PlanService, plan_resolver_1.PlanResolver],
